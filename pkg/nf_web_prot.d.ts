...
export interface InitOutput {
    ...
    readonly wasm_serialize_packet: (a: number, b: number, c: number, d: number, e: bigint, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number, o: number, p: number) => [number, number, number, number];
    readonly wasmdecodedpacket_body: (a: number) => [number, number];
    readonly wasmdecodedpacket_codec: (a: number) => [number, number];
    readonly wasmdecodedpacket_mask_index: (a: number) => [number, number];
    readonly wasmdecodedpacket_mask_white_ratio: (a: number) => [number, number];
